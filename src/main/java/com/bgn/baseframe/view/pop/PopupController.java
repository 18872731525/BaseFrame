package com.bgn.baseframe.view.pop;
...
class PopupController {
     ...
     * @param touchable 是否可点击
     */
    private void setOutsideTouchable(boolean touchable, PopupWindow.OnDismissListener callback) {
        popupWindow.setBackgroundDrawable(new ColorDrawable(0x00000000));//设置透明背景
        popupWindow.setOutsideTouchable(touchable);//设置outside可点击
    ...
    static class PopupParams {
        ...
        public void apply(PopupController controller) {
            ...
            if (onDismissListener != null) {
                controller.setOutsideTouchable(isTouchable,onDismissListener);
            } else {
