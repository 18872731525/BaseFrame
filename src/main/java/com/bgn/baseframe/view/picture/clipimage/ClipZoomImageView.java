...
public class ClipZoomImageView extends ImageView implements
    ...
    public void setAllShowPicture(boolean allShowPicture) {
        isAllShowPicture = allShowPicture;
    }

    private boolean isAllShowPicture = false;
                ...
                new SimpleOnGestureListener() {
                    ...
                    public boolean onSingleTapConfirmed(MotionEvent e) {
                        if (mClickListener != null) {
                            mClickListener.onClick(ClipZoomImageView.this);
                            return true;
                        }
    ...
    public void onGlobalLayout() {
        if (once) {
            ...
            Log.e("TAG", "图片的宽 = " + dw + ", 控件的宽 = " + width + ", 图片的高 = " + dh + ", 控件的高 = " + height);
            ...
            if (isAllShowPicture) {
                ...
                } else /*(dw < width - mHorizontalPadding * 2
                    && dh < height - mVerticalPadding * 2) */ {
                    float scaleW = (width * 1.0f - mHorizontalPadding * 2) / dw;
                    float scaleH = (height * 1.0f - mVerticalPadding * 2) / dh;
                    scale = Math.max(scaleW, scaleH);
                    Log.e("false", "scale = " + scale);
                    Log.e("false", "scaleW = " + scaleW + ", scaleH = " + scaleH);
                }
            }
