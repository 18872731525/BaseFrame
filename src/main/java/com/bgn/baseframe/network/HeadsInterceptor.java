...
public class HeadsInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        String cokeText = "ecjia_token=" +  PreferUtil.getString(PreferUtil.ACCESS_TOKEN, "");
        builder.header("Cookie", cokeText);
        builder.header("Device-client", "android");
        builder.header("Device-code", "4001");
        builder.header("Device-udid", DeviceUtils.getUdid());
        builder.header("Api-version", "1.13");
