...
import com.bgn.baseframe.LanguageContextWrapper;
...
public class BasePermissionsAndStackActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void attachBaseContext(Context newBase) {
        String language2country= LanguageUtil.getSavedLanguage2Country();
        Locale newLocale = LanguageUtil.getLocaleByString(language2country);
